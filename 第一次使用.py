...
CHANNEL_ACCESS_TOKEN_ent = tk.StringVar(None)
...
CHANNEL_SECRET_ent = tk.StringVar(None)
...
TDX_Client_ID_ent = tk.StringVar(None)
...
TDX_Client_Secret_ent = tk.StringVar(None)
...
GoogleMap_API_Key_ent = tk.StringVar(None)
